import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};globalThis.__timing__.logStart('Load chunks/routes//renderer');import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'vue-bundle-renderer/runtime';
...
export { baseURL as b, renderer$1 as r };;globalThis.__timing__.logEnd('Load chunks/routes//renderer');
